...
AWS_REGION  = 'false' if os.environ.get('AWS_REGION') is None else os.environ.get('AWS_REGION')
STARTUP_SIGNUP_TABLE = 'false' if os.environ.get('STARTUP_SIGNUP_TABLE') is None else os.environ.get('STARTUP_SIGNUP_TABLE')
NEW_SIGNUP_TOPIC = 'false' if os.environ.get('NEW_SIGNUP_TOPIC') is None else os.environ.get('NEW_SIGNUP_TOPIC')
